        ...
        <div className="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-xs">
            ...
            <table className="w-full text-left text-xs text-slate-600">
              ...
              <tbody className="divide-y divide-slate-100">
                {paginatedFornecedores.map((fornecedor) => (
                  <tr key={fornecedor.id} className="hover:bg-slate-50/70 transition-colors">
                      ...
                      <div className="flex flex-col gap-0.5">
                        {fornecedor.telefone && (
                          <span className="flex items-center gap-1 text-slate-700">
                            <Phone className="w-3 h-3 text-slate-500" /> {fornecedor.telefone}
                          </span>
                        )}
                        {fornecedor.email && (
                    ...
                    <td className="py-3 px-4 text-right">
                      {canManage ? (
                        ...
                        <span className="text-slate-400 text-[11px]">Visualização</span>
                      )}
                    </td>
                  </tr>
                ))}
          ...
          <div className="flex items-center justify-between px-4 py-3 border-t border-slate-100 bg-slate-50/50 text-xs text-slate-600">
            <div>
              ...
              de <span className="font-semibold text-slate-900">{filteredFornecedores.length}</span>{' '}
              fornecedores
            </div>
