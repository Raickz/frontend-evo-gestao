        ...
        <div className="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-xs">
                      ...
                      <div className="flex flex-col gap-0.5">
                        {cliente.telefone && (
                          <span className="flex items-center gap-1 text-slate-700">
                            <Phone className="w-3 h-3 text-slate-500" /> {cliente.telefone}
                          </span>
                        )}
                        {cliente.email && (
                        ...
                        <Button
                          ...
                          onClick={() => {
                            if (cliente.ativo) {
                              ...
                              // If inactive, can activate directly or confirm
                              setConfirmToggleCliente(cliente)
                            }
                          }}
          ...
          <div className="flex items-center justify-between px-4 py-3 border-t border-slate-100 bg-slate-50/50 text-xs text-slate-600">
            <div>
              ...
              de <span className="font-semibold text-slate-900">{filteredClientes.length}</span>{' '}
              clientes
            </div>
